...
const LoginSuccess = ({ setUser }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0c0c0e] flex flex-col items-center justify-center px-4 sm:px-6 overflow-hidden relative">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="relative mb-16">
          <div className="w-24 h-24 md:w-32 md:h-32 border border-indigo-500/10 rounded-full animate-[ping_4s_cubic-bezier(0,0,0.2,1)_infinite]"></div>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-14 h-14 md:w-20 md:h-20 border-2 border-indigo-500/20 border-t-indigo-500 rounded-full animate-spin"></div>
          </div>
          <div className="absolute inset-0 flex items-center justify-center">
