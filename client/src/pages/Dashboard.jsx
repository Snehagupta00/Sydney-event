...
const Dashboard = ({ user }) => {
  ...
  return (
    <div className="min-h-screen bg-bg-deep pt-36 pb-12 px-4 sm:px-6 md:px-10 selection:bg-rose-500/30">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          ...
          <div className="flex gap-3 items-center flex-wrap">
            ...
            <div className="flex flex-col items-end gap-2">
              ...
              {scrapeMessage && (
                <div className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest animate-in fade-in duration-300 ${scrapeMessage.type === 'success'
