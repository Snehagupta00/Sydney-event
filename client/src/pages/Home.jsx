import { ArrowRight, MapPin, Search, ShieldCheck, Sparkles, Star, Zap } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-deep selection:bg-indigo-500 selection:text-white flex flex-col px-4 sm:px-6 md:px-12">
